                        ...
                        <div class="row">  
                          <div class="col -lg-12">
                            <div class="panel -dark -focused">
                              <div class="panel-heading -dark -with-icon-lg"><i class="pe pe-plus"></i>
                                <h3>Sign Up</h3><span>We'll never share your credentials with anyone.</span>
                              </div>
                              <div class="panel-body"> 
                                <form class="form -dark" id="form-signup" action="/" data-toggle="validator" method="POST">
                                  ...
                                  <!-- /Form Group-->
                                  <div class="form-group">
                                    <label class="form-label" for="form-signup-ebay-id">Ebay ID</label>
                                    <input class="form-control" id="form-signup-ebay-id" name="ebay_id" type="text" required="required" placeholder="Enter Your Ebay ID"/>
                                  </div>
                                  <!-- Form Group-->
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input class="form-control" id="form-signup-password" name="password" type="password" required="required" placeholder="Password"/>
                                  </div>
                                  <!-- /Form Group-->
                                  <!-- Form Group-->
                                  <div class="form-group">
                                    <input class="form-control" id="form-signup-password-confirmation" name="cnfpassword" type="password" required="required" placeholder="Password Confirmation" data-match="#form-signup-password"/>
                                  </div>
                                  <!-- /Form Group-->
                                  <!-- Form Group-->
                                  <div class="form-group _margin-top-2x _margin-bottom-none">
                                    <div class="form-check -checkbox"> 
                                      <button class="btn -primary -block" type="submit" name="signup">Signup      </button>
                                    </div>
                                  </div>
                                  <!-- /Form Group-->
                                </form>
                            ...
                            <p class="_text-center"><a class="_text-muted" href="<?php echo base_url('auth');?>/">I already have an account, sign me in!</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
