$(document).ready ->
  ...
  draw_sparklines = ->
    ...
    Sales Sparkline
    ###
    width = if threshold then Math.floor $("#chart-sales-status").parent().width() else 150
    ...
    Users Sparkline
    ###
    width = if threshold then Math.floor $("#chart-users-status").parent().width() else 150
    ...
    ###
    width = if threshold then Math.floor $("#chart-impressions-status").parent().width() else 150
    ...
    Downloads Sparkline
    ###
    width = if threshold then Math.floor $("#chart-downloads-status").parent().width() else 150
  ...
  if $('#chart-project-progress').length > 0
    ...
    flot_tooltip_binding = (event, pos, item) ->
      if (item)
    ...
    options =
      ...
      series:
        lines:
          ...
          fill: true
          color: colors['white']
          fillColor: colors: [ {opacity: 0.25}, {opacity: 0.75} ]
        points:
          show: true
