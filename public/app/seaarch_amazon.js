      ...
      $this = $(this);
       ...
       //alert(sch_id);
                  ...
                  confirmButtonText: 'Yes, do it!'
                    ...
                    swal({
                      ...
                      //console.log(arr_upc);
                            $.ajax({
                              type: "POST",
                              url: "<?php echo base_url()?>" + "index.php/Amazon/search/",
                              data: {array_upc:arr_upc,array_ean:arr_ean,search_from:search_from}
                                ...
                                if(data['price']) {
                                  ...
                                  //console.log(amazon_item_price);


     
                                 // var sell_price = "32";
                                   //var amazon_link = "https://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Daps&field-keywords";
                                  //console.log(amazon_item_price);
                                  //console.log(amazon_item_img);
                                  //console.log(upc[0][0]);
                                  //console.log(amazon_item_price[0][0]);
                                  //console.log(amazon_item_img[0][0]);
                                  //var ean ="";
                                }
                                ...
                                //test
                                  ...
                                  $.ajax({
                                  type: "POST",
                                  url: "<?php echo base_url()?>" + "index.php/Search/insert_amazon/",
          ...
          // If fail
              ...
              //                         type: "POST",
              //                         url: "<?php echo base_url()?>" + "index.php/Search/insert_amazon/",
              //                         data: {upc:upc,ean:ean,sch_id:sch_id,ebay_sold_price:sell_price,amazon_price:amazon_item_price,amazon_link:amazon_link,amazon_item_img:amazon_item_img}
              //                          }).done(function(response){
              //                             console.log(response);
              //                           }).fail(function(jqXHR, textStatus, errorThrown) {
              // // If fail
